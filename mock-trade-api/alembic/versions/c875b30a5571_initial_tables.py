...
Revision ID: c875b30a5571
Revises: 
Create Date: 2025-10-16 12:26:56.177144
...
def upgrade() -> None:
    ...
    op.drop_table('trade_allocation', if_exists=True)
    op.drop_table('position_daily', if_exists=True)
    op.drop_table('settlement_price', if_exists=True)
    op.drop_table('account', if_exists=True)
    op.drop_table('eod_pnl', if_exists=True)
    op.drop_table('broker', if_exists=True)
    op.drop_table('variation_margin', if_exists=True)
    op.drop_table('trader', if_exists=True)
    op.drop_table('audit_log', if_exists=True)
    op.drop_table('final_settlement_price', if_exists=True)
...
def downgrade() -> None:
    ...
    sa.PrimaryKeyConstraint('trader_id', name='trader_pkey'),
