...
Provides a simple in-memory event bus that allows modules to publish and subscribe
to events without direct coupling. Can be extended with message queues (RabbitMQ, Kafka)
for production use.
"""
